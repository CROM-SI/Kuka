...
<div id="form">
    ...
    <br/>
    <h10 class="campoenrojo">*</h10>Precio: <input type="text" style="color:black;margin-left: 15%; margin-bottom:2%; width: 36%;border-radius: 6px" name="precioPro" class="input" required="true" />
    <br/>
    <h10 class="campoenrojo">*</h10>Stock: <input type="text" style="color:black;margin-left: 15%; margin-bottom:2%; width: 36%;border-radius: 6px" name="stockPro" class="input" required="true" />
    <br/>
