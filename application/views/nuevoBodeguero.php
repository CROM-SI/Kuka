...
<div id="form">
    ...
    <br/>
    <h10 class="campoenrojo">*</h10>
    Apellido: <input type="text" id="apellidoBod" required="true"
                     style="
                               color:black;
                               margin-left: 9%;
                               margin-bottom:2%; 
    ...
    <br/>
    <h10 class="campoenrojo">*</h10>
    Rut: <input type="text" id="rutBod" required="true"
                style="color:black;
                          margin-left: 14%;
                          margin-bottom:2%;
                          width: 32%;
                          border-radius: 6px"/>
     <input type="text"  id="digitoBod" 
               style="color:black;
               margin-left: 4%;
               margin-bottom:2%;
               width: 8%;
    ...
    <br/>
    <h10 class="campoenrojo">*</h10>
    Nickname: <input type="text" id="nicknameBod"  required="true"
                     style="
                               color:black;
                               margin-left: 8%;
                               margin-bottom:2%; 
    ...
    <br/>
    <h10 class="campoenrojo">*</h10>
    Password: <input type="text" id="passwordBod" required="true"
                     style="
                               color:black;
                               margin-left: 9%;
                               margin-bottom:2%; 
